...
###############################################################################
    def __init__(self,name,MORB_array,HARZ_array,TEMP_array):
###############################################################################
...
###############################################################################
        ...
        MORB_file = open(self.name+'_MORB_output.dat','w+')
        HARZ_file = open(self.name+'_HARZ_output.dat','w+')
        TEMP_file = open(self.name+'_TEMP_output.dat','w+')
